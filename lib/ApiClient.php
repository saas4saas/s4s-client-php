...
class ApiClient
{
     ...
     */
    public function __construct(\s4s\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \s4s\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\s4s\ObjectSerializer::sanitizeForSerialization($postData));
        }
