...
/**
 * DataListUserApi Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     s4s
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DataListUserApi implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DataListUserApi';
