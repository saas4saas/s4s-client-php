 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OneTimePay implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'OneTimePay';
