...
class CustomerBill implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_id_list'] = isset($data['payment_id_list']) ? $data['payment_id_list'] : null;
        $this->container['plan_id'] = isset($data['plan_id']) ? $data['plan_id'] : null;
        $this->container['last_bill_id'] = isset($data['last_bill_id']) ? $data['last_bill_id'] : null;
    }
    ...
    {
        return $this->container['last_bill_id'];
    }
     ...
     * @return $this
     */
    public function setLastBillId($last_bill_id)
    {
        $this->container['last_bill_id'] = $last_bill_id;
