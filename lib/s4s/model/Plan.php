...
class Plan implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'variable_cost' => 'map[string,\s4s\model\VariableCost]',
        'name' => 'string',
        'one_time_pay' => '\s4s\model\OneTimePay',
        'has_variable_cost' => 'bool',
        'description' => 'string',
        'subscription' => '\s4s\model\Subscription',
    ...
    /**
     * Gets variable_cost
     * @return map[string,\s4s\model\VariableCost]
     */
    ...
    /**
     * Sets variable_cost
     * @param map[string,\s4s\model\VariableCost] $variable_cost
     * @return $this
     */
    ...
    /**
     * Sets one_time_pay
     * @param \s4s\model\OneTimePay $one_time_pay
     * @return $this
     */
    ...
    /**
     * Sets subscription
     * @param \s4s\model\Subscription $subscription
     * @return $this
     */
